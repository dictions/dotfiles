...
# Menu bar: hide the Time Machine, Volume icons
...
# Increase Text Size for icons on the desktop and in other icon views
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:textSize 16" ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c "Set :FK_StandardViewSettings:IconViewSettings:textSize 16" ~/Library/Preferences/com.apple.finder.plist
